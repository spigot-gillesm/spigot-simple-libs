...
public final class SpellCooldown {
	 ...
	 */
	public void start(final String id, final double time) {
	...
	public boolean isOnCooldown(final String id) {
		return idInCooldown.containsKey(id);
	}

	public BigDecimal remainingTime(final String id, double originalCooldown) {
		if(isOnCooldown(id)) {
